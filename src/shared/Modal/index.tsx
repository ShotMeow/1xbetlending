...
const Modal: FC<Props> = ({ setIsShown }) => {
  ...
  return (
    <div className="fixed z-50 left-0 top-0 w-full h-full bg-black/40 flex items-start xl:py-10 xl:items-center justify-center">
      <form className="relative flex xl:flex-row flex-col-reverse justify-between gap-4 h-full xl:h-[549px] overflow-y-auto xl:overflow-y-visible bg-white border-blue-light border rounded-md text-ocean-dark p-4 w-full xl:w-[1000px]">
        ...
        <div className="bg-[url('/logo-dark.png')] bg-contain bg-no-repeat bg-center w-full h-full xl:w-[506px] xl:h-[calc(100%+60px)] relative xl:-top-8 rounded-lg bg-[#015291] text-center flex flex-col items-center justify-center gap-20 p-6">
          <button
            type="button"
          ...
          <Button darkMode className="px-4 hidden xl:flex">
            {translateForm("button")}
            <svg
              width="14"
              height="24"
